namespace GameFifteen.Exceptions.PlayerExceptions
{
    ...
    public class PlayerException : GameException
    {
        ...
        public PlayerException(string format, params object[] args) : base(string.Format(format, args))
        {
        ...
        public PlayerException(string format, Exception innerException, params object[] args) : base(string.Format(format, args), innerException)
        {
